...
import { getCourseInDepartmentFromDb, getDepartmentBySlugFromDb } from '../lib/db.js';
import { Course } from '../types';
    
export async function listCourse(req: Request, res: Response, next: NextFunction) {
